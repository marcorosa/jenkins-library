...
type credentialdiggerTestStepOptions struct {
...
// CredentialdiggerTestStepCommand Comment on GitHub issues and pull requests.
func CredentialdiggerTestStepCommand() *cobra.Command {
	const STEP_NAME = "credentialdiggerTestStep"

	metadata := credentialdiggerTestStepMetadata()
	var stepConfig credentialdiggerTestStepOptions
	var startTime time.Time
	var logCollector *log.CollectorHook
	var splunkClient *splunk.Splunk
	telemetryClient := &telemetry.Telemetry{}

	var createCredentialdiggerTestStepCmd = &cobra.Command{
		Use:   STEP_NAME,
...
This comes in very handy when you want to make developers aware of certain things during a PR voting process, for example.`,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			credentialdiggerTestStep(stepConfig, &stepTelemetryData)
			stepTelemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addCredentialdiggerTestStepFlags(createCredentialdiggerTestStepCmd, &stepConfig)
	return createCredentialdiggerTestStepCmd
}

func addCredentialdiggerTestStepFlags(cmd *cobra.Command, stepConfig *credentialdiggerTestStepOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.Repository, "repository", os.Getenv("PIPER_repository"), "URL of the GitHub repository.")
...
func credentialdiggerTestStepMetadata() config.StepData {
	var theMetaData = config.StepData{
		Metadata: config.StepMetadata{
			Name:        "credentialdiggerTestStep",
